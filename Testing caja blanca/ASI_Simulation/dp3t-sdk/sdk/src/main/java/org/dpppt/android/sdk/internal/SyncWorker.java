...
public class SyncWorker extends Worker {
	...
	private static void doSyncInternal(Context context) throws IOException, StatusCodeException, ServerTimeOffsetException {
		...
		Exposed.ProtoExposedList result = backendBucketRepository.getExposees(nextBatchReleaseTime);
		...
		appConfigManager.setLastLoadedBatchReleaseTime(nextBatchReleaseTime);
