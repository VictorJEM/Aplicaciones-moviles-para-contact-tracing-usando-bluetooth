...
public class BleClient {
	...
	public BluetoothState start() {
		...
		//Log.i("info", "started BLE scanner, scanMode: " + scanSettings.getScanMode() + " scanFilters: " + scanFilters.size());
	...
	private void onDeviceFound(ScanResult scanResult) {
		try {
			...
			Log.i("info", "BleClient - Dirección Bluetooth: " + deviceAddr + "; Nivel Potencia: " + power + "; RSSI: " + scanResult.getRssi());
			...
			if (correctPayload) {
				...
				String payl = new String(Hex.encodeHex(payload));
				Log.i("info", "Llave recibida: " + payl);
