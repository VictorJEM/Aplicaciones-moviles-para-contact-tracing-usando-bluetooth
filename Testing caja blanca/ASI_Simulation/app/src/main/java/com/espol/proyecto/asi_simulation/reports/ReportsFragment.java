package com.espol.proyecto.asi_simulation.reports;
...
import com.espol.proyecto.asi_simulation.util.PhoneUtil;
...
public class ReportsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        infoLinkHealthy.setOnClickListener(v -> openLink(R.string.faq_button_url));
